      ...
      <div className="container mx-auto px-6 relative z-10 max-w-6xl">
        <div className="flex flex-col md:flex-row justify-between items-end mb-20 gap-6">
          <div className="max-w-xl text-left">
            ...
            <h3 className="text-4xl md:text-5xl font-bold text-slate-900 dark:text-blue-50 mb-0 leading-[1.1]">Performance</h3>
          </div>
        ...
        <div className="space-y-16">
          ...
          <div>
            <div className="flex items-center gap-3 mb-8">
              ...
              <h3 className="text-2xl font-bold text-slate-900 dark:text-blue-50">GitHub Open Source</h3>
            </div>
            
            <div className="grid lg:grid-cols-3 gap-8 items-stretch">
              {/* GitHub Card */}
              <div className="lg:col-span-1 bg-white dark:bg-blue-950 p-8 rounded-3xl border border-slate-100 dark:border-blue-800 hover:border-slate-200 transition-all group relative overflow-hidden shadow-sm hover:shadow-xl hover:shadow-slate-500/5">
                ...
                <div className="flex items-center gap-4 mb-8 relative z-10">
                  <div className="w-12 h-12 rounded-2xl bg-slate-50 dark:bg-blue-900/50 flex items-center justify-center shadow-sm border border-slate-100 dark:border-blue-800 group-hover:scale-110 transition-transform">
                    <GithubIcon className="w-6 h-6 text-slate-700" />
                  </div>
                  <div>
                    <h3 className="font-bold text-slate-900 dark:text-blue-50">Stats</h3>
                  ...
                  {githubData.loading ? (
                    ...
                    <>
                      <div className="flex justify-between items-center pb-4 border-b border-slate-50">
                        <span className="text-sm font-semibold text-slate-500 dark:text-blue-300 flex items-center gap-2"><GitCommit className="w-4 h-4"/> Repositories</span>
                        <span className="font-black text-slate-900 dark:text-blue-50 text-lg">{githubData.repos}</span>
                      </div>
                      <div className="flex justify-between items-center">
                        <span className="text-sm font-semibold text-slate-500 dark:text-blue-300 flex items-center gap-2"><Users className="w-4 h-4"/> Followers</span>
                        <span className="font-black text-slate-900 dark:text-blue-50 text-lg">{githubData.followers}</span>
                      </div>
                    </>
                  )}
                </div>
              ...
              <div className="lg:col-span-2 space-y-6">
                {/* 365-Day Heatmap */}
                <div className="bg-white dark:bg-blue-950 p-8 rounded-3xl border border-slate-100 dark:border-blue-800 shadow-sm hover:shadow-xl hover:shadow-blue-500/5 transition-all duration-500 relative group overflow-hidden flex flex-col justify-center">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="bg-white dark:bg-blue-950 p-6 rounded-3xl border border-slate-100 dark:border-blue-800 shadow-sm hover:shadow-lg hover:shadow-blue-500/5 transition-all flex items-center justify-center">
                    <img 
          ...
          <div>
            <div className="flex items-center gap-3 mb-8">
              ...
              <h3 className="text-2xl font-bold text-slate-900 dark:text-blue-50">LeetCode Problem Solving</h3>
            </div>
            
            <div className="grid lg:grid-cols-3 gap-8 items-stretch">
              {/* LeetCode Card */}
              <div className="lg:col-span-1 bg-white dark:bg-blue-950 p-8 rounded-3xl border border-orange-100/50 hover:border-orange-200 transition-all group relative overflow-hidden shadow-sm hover:shadow-xl hover:shadow-orange-500/5">
                  ...
                  {leetcodeData.loading ? (
                    ...
                    <>
                      <div className="flex justify-between items-center pb-4 border-b border-orange-50">
                        <span className="text-sm font-semibold text-slate-500 dark:text-blue-300 flex items-center gap-2"><Trophy className="w-4 h-4 text-orange-400"/> Total Solved</span>
                        <span className="font-black text-slate-900 dark:text-blue-50 text-lg">{leetcodeData.solved}</span>
                      </div>
              ...
              {/* LeetCode Heatmap */}
              <div className="lg:col-span-2 bg-white dark:bg-blue-950 p-8 rounded-3xl border border-orange-100/50 shadow-sm hover:shadow-xl hover:shadow-orange-500/5 transition-all duration-500 relative group overflow-hidden flex flex-col justify-center">
          ...
          <div>
            <div className="flex items-center gap-3 mb-8">
              ...
              <h3 className="text-2xl font-bold text-slate-900 dark:text-blue-50">LinkedIn Network</h3>
            </div>
            
            <div className="grid lg:grid-cols-3 gap-8 items-stretch">
              {/* LinkedIn Card */}
              <div className="lg:col-span-1 bg-white dark:bg-blue-950 p-8 rounded-3xl border border-blue-100/50 hover:border-blue-200 transition-all group relative overflow-hidden shadow-sm hover:shadow-xl hover:shadow-blue-500/5">
                ...
                <div className="space-y-4 relative z-10">
                  <div className="flex justify-between items-center pb-4 border-b border-blue-50">
                    <span className="text-sm font-semibold text-slate-500 dark:text-blue-300 flex items-center gap-2"><Users className="w-4 h-4 text-blue-500"/> Connections</span>
                    <span className="font-black text-slate-900 dark:text-blue-50 text-lg">{linkedinData.connections}</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-sm font-semibold text-slate-500 dark:text-blue-300 flex items-center gap-2"><Activity className="w-4 h-4 text-blue-500"/> Followers</span>
                    <span className="font-black text-slate-900 dark:text-blue-50 text-lg">{linkedinData.followers}</span>
                  </div>
                </div>
              </div>
              
              {/* Placeholder for future LinkedIn features */}
              <div className="lg:col-span-2 bg-white/50 p-8 rounded-3xl border border-slate-100 dark:border-blue-800 border-dashed flex flex-col items-center justify-center text-center">
                 <div className="w-16 h-16 rounded-full bg-slate-100 flex items-center justify-center mb-4">
                   <Activity className="w-8 h-8 text-slate-300" />
                 </div>
                 <h4 className="text-slate-500 dark:text-blue-300 font-bold mb-2">More Network Analytics Coming Soon</h4>
          ...
          <div>
            <div className="flex items-center gap-3 mb-8">
              ...
              <h3 className="text-2xl font-bold text-slate-900 dark:text-blue-50">Language Learning</h3>
            </div>
            
            <div className="grid lg:grid-cols-3 gap-8 items-stretch">
              {/* Duolingo Heatmap / Stats Card */}
              <div className="lg:col-span-3 bg-white dark:bg-blue-950 p-8 rounded-3xl border border-green-100/50 shadow-sm hover:shadow-xl hover:shadow-green-500/5 transition-all duration-500 relative group overflow-hidden flex flex-col justify-center items-center">
