...
const Certificates = () => {
  ...
  return (
    <AnimatedPage className="min-h-[calc(100vh-80px)] py-20 bg-white dark:bg-blue-950 text-slate-900 dark:text-blue-50">
      <div className="container mx-auto px-6 max-w-5xl">
        <div className="text-center mb-16">
          ...
          <h3 className="text-4xl md:text-5xl font-bold text-slate-900 dark:text-blue-50">Professional Certifications</h3>
        </div>
        
        <div className="grid gap-6">
          {certifications.map((cert, idx) => (
            <div key={idx} className="group flex flex-col md:flex-row md:items-center justify-between p-8 rounded-3xl border border-slate-100 dark:border-blue-800 bg-white dark:bg-blue-950 hover:bg-slate-50 dark:bg-blue-900/50 hover:border-primary-blue/30 transition-all shadow-sm hover:shadow-xl relative overflow-hidden">
              {cert.highlight && (
              ...
              <div className="flex items-center gap-6">
                ...
                <div>
                  <div className="flex items-center gap-3 mb-1">
                     <h4 className="text-xl font-bold text-slate-900 dark:text-blue-50 leading-tight">{cert.title}</h4>
              ...
              <div className="mt-6 md:mt-0 flex flex-col items-start md:items-end gap-3 border-t md:border-t-0 border-slate-100 dark:border-blue-800 pt-6 md:pt-0">
                ...
                <div className="flex flex-wrap md:justify-end gap-2">
                  {cert.skills.slice(0, 3).map(skill => (
                    <span key={skill} className="px-3 py-1 bg-white dark:bg-blue-950 border border-slate-100 dark:border-blue-800 text-slate-500 dark:text-blue-300 text-[10px] font-bold uppercase rounded-md shadow-sm">{skill}</span>
                  ))}
                </div>
              </div>
            </div>
